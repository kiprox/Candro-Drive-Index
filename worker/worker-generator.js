...
const jsURL = 'https://raw.githubusercontent.com/kiprox/Candro-Drive-Index/master/worker/worker-beta.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Candro Drive Index';
